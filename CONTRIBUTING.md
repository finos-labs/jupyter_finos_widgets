...
* Use `fdc3.` to make all fdc3 calls within your models. This makes it easier to read whether or not something is a class method without relying on specific syntax. If there are bundle size implications we would be happy to reconsider. I have only checked briefly and saw no improvements.
